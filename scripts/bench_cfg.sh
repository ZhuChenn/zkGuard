...
ZKV_NODE_EXE=${ZKV_NODE_EXE:-"${PROJECT_ROOT}/target/production/zkguard"}
ZKV_RUNTIME=${ZKV_RUNTIME:-"${PROJECT_ROOT}/target/production/wbuild/zkguard-runtime/zkguard_runtime.compact.compressed.wasm"}
